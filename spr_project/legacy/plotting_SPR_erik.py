...
colors  = ['black', 'lightcoral', 'red', 'lightgreen', 'blue', 'lightblue']
marking = ['', '--', '', '--', '--', '--']
...
y_layers = np.array([50, 120, 270, 470, 710, 950, 1250, 1600])
for i in range(len(y_layers)):
    plt.plot(np.array([x_layers[0], x_layers[1]]), np.array([y_layers[i], y_layers[i]]), '--', color='gray', linewidth=0.5)
...
sav_gol_window = 20
sav_gol_order = 5
plot_raw, plot_moving_avg, plot_savgol, frame_time = load_measurement_data(spr_data_folder, files_to_plot,
                                                               mov_avg_window=mov_avg_window,
                                                               sav_gol_window=sav_gol_window, sav_gol_order=sav_gol_order)
...
plt.xlim([frame_time[2], frame_time[-5]/time_scale])
plt.grid(True)
plt.xlabel(r'Time [min]')
plt.title(r'Noise with water')
...
## Load all data
spr_data_folder = 'spr_measurement_data/spr_measurements_231220'
...
sav_gol_window = 100
sav_gol_order = 5
plot_raw, plot_moving_avg, plot_savgol, frame_time = load_measurement_data(spr_data_folder, files_to_plot, vcsels, time_mask=time_mask,
                                                               mov_avg_window=mov_avg_window,
                                                               sav_gol_window=sav_gol_window, sav_gol_order=sav_gol_order)
